 <?php ob_start();
    ...
    if(isset($_POST['update_post']))
    {
        ...
        if(!$update_post)
        {
            die('UNABLE TO UPDATE POST '.mysqli_error($connection));
        }
    }
?>
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <select name="post_category" id="">
           <?php
            ...
            {
                die('UNABLE TO OBTAIN CATEGORIES '.mysqli_error($connection));
            }
    ...
    <div class="form-group">
        ...
        <img width='200' src="../images/<?php echo $post_image ?>" alt=""><br>
